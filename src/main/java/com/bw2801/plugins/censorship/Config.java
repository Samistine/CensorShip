...
public class Config {
    ...
    private static void loadMessages() {
        ...
        config.addDefault("messages.tempbanned-login", "You are banned for the next <minutes> minutes.");
        config.addDefault("messages.tempbanned", "You were banned for <minutes> minutes for using forbidden words.");
        config.addDefault("messages.tempbanned-public", "<player> was banned for <minutes> minutes for using forbidden words.");
        ...
        config.addDefault("messages.muted-public", "<player> is now muted for <minutes> minutes.");

// This is the code of the Updater by h31ix. I just copied the code into my plugin.
...
public class Updater 
{
    ...
    private String updateFolder = "CensorShip/updates"; // The folder that downloads will be placed in
